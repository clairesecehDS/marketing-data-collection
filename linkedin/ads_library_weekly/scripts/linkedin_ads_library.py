...
class LinkedInAdsLibraryClient:
    ...
    def search_ads_by_keyword(self, keyword: str, countries: Optional[List[str]] = None,
        ...
        Args:
            ...
            date_range: Plage de dates {'start': {'day': 1, 'month': 1, 'year': 2023}, 'end': {...}}
        ...
        # Ajouter le filtre dateRange si spécifié
        # Format: dateRange=(start:(day:1,month:1,year:2023),end:(day:2,month:1,year:2023))
        if date_range:
