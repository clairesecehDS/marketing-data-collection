#!/bin/bash
#
# Déploiement Cloud Run Job pour verbus-480211 - Events
...
REGION="europe-west1"
JOB_NAME="spyfu-monthly-events"
IMAGE_NAME="gcr.io/${PROJECT_ID}/${JOB_NAME}"

# Configuration SpyFu pour Events
# Utilise config_verbus_events.yaml
CONFIG_FILE="config_verbus_events.yaml"

echo "============================================================"
echo "  Déploiement Cloud Run Job - Verbus Events"
echo "============================================================"
...
# 5. Créer le Cloud Scheduler (1er de chaque mois à 0h10 UTC = 1h10 Paris)
...
echo "☁️  Job: $JOB_NAME"
echo "📊 Dataset: $DATASET"
echo "⏰ Schedule: 1er de chaque mois à 1h10 (heure de Paris)"
echo ""
