#!/bin/bash
#
# Déploiement Cloud Run Job pour ecoledesponts
...
# Configuration SpyFu pour ecoledesponts
# Utilise config_ecoledesponts.yaml
CONFIG_FILE="config_ecoledesponts.yaml"

echo "============================================================"
echo "  Déploiement Cloud Run Job - ecoledesponts"
echo "============================================================"
